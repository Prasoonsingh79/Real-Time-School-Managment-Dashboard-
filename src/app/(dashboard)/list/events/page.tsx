...
// import { getCurrentUserId } from "@/lib/utils"; // ✅ ADDED
...
//   const { userId: currentUserId, role } = await getCurrentUserId(); // ✅ FIXED HERE
...
//         <h1 className="hidden md:block items-center justify-center font-bold text-4xl">
//           All Events
//         </h1>
