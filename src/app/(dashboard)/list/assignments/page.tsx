...
// import { assignmentsData, examsData, lessonsData, parentsData, studentsData, subjectsData, teachersData } from "@/lib/data";
...
//       : []),
//   ];
// const renderRows = (item: AssignmentList) => (
...
// app/dashboard/assignments/page.tsx (or wherever this file lives)
...
//   subjectsData,
//   teachersData,
//   role as staticRole, // If you want to keep a default
// } from "@/lib/data";
...
//     className: "hidden md:table-cell",
//   },
//   ...(staticRole === "admin" || staticRole === "teacher"
//     ? [
//         {
//           headers: "Actions",
//           accessor: "action",
...
//   const role = (sessionClaims?.metadata as { role?: string })?.role || staticRole;
