...
// const renderRows = (item: AnnouncementList) => (
...
//         <h1 className="hidden md:block items-center justify-center font-bold text-4xl">All Annoucments</h1>
...
//             </button>
//             {role === "admin" ||(role=="teacher"  &&  (<FormModal table="announcement" type="create" />))}
//           </div>
//         </div>
//       </div>
...
// Define the announcement type with class relation
type AnnouncementList = Announcement & { class: Class };
