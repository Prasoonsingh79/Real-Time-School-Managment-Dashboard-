...
// import { getCurrentUserId } from "@/lib/utils"; // ✅ dynamic role
...
// }) => {
//   const { userId, role } = await getCurrentUserId(); // ✅
...
//               <button className="w-8 h-8 flex items-center justify-center bg-lamaSky rounded-full">
